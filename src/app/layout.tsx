  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="fisioterapia-ignacio-vejo";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Fisioterapia Ignacio Vejo Santander"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="fisioterapia-ignacio-vejo"
      ...
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="fisioterapia-ignacio-vejo";
